...
module ApplicationHelper
  ...
  include SquadsHelper # The squads_partial_path helper method won't be available in home page, because we render posts inside the home page’s template, which belongs to a different controller. To have an access to this method, inside the home page's template, include PostsHelper here
end
